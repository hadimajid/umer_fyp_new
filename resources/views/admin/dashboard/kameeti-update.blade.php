                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Update Saving Wallet Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="price" id="price" required value="{{$kameeti->price}}" >
                                                        @error('price')
                                                        <label for="" style="color: red">{{$message}}</label>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="amount" id="amount" required value="{{$kameeti->amount}}" readonly>
                                                        @error('amount')
                                                        <label for="" style="color: red">{{$message}}</label>
                                                        @enderror
                                                    </div>
